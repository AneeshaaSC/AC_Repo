...
print('Number of samples with RightUpper data(Zone-2):',numorm.shape[0])
print('Number of samples with RightUpper data(Zone-3):',numorl.shape[0])
print('Number of samples with RightUpper data(Zone-4):',numolu.shape[0])
print('Number of samples with RightUpper data(Zone-5):',numolm.shape[0])
print('Number of samples with RightUpper data(Zone-6):',numoll.shape[0])
print(' ')
print(' ')
...
def drop_useless_features(predictors,target):
    ...
    #accuracy_1 = cross_val_score(classifier, predictors, target,cv=loo)
    #print('Accuracy before feature selection:', accuracy_1.mean()*100,'%')
    ...
    #accuracy_2 = cross_val_score(classifier, predictors, target,cv=loo)
    #print('Accuracy after feature selection:', accuracy_2.mean()*100,'%')
    return predictors
...
def get_y_pred(dfname,df_tar):
    model = LogisticRegression()
    pred_y = cross_val_predict(model, dfname, df_tar,cv=loo)
