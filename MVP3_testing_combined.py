...
#temp1[['flight_number','flight_boarding_time']].groupby(['flight_number']).max().reset_index()
#M1[['flight_number','flight_boarding_time']].groupby(['flight_number']).max().reset_index()

#train_df = pd.read_csv('MVP3_testing_Historical_data.csv', parse_dates = ['flight_boarding_time'])
train_df = pd.read_csv('MVP3_testing_Historical_data_June_21_27_28.csv', parse_dates = ['flight_boarding_time'])
train_df['split'] = 1
...
test_df = pd.read_csv('MVP3_testing_Future_data_June_21_27_28.csv',parse_dates = ['flight_boarding_time'])
test_df['split'] = 0
...
output.to_csv('MVP3_testing_output_Jun28.csv', index=False)
comp.to_csv('MVP3_testing_output_Jun28_full.csv', index=False)
############################################################
...
#max dates
#zz = train_df[['flight_number', 'flight_boarding_pt','flight_boarding_time']].groupby(['flight_number', 
#             'flight_boarding_pt']).max().reset_index()
#zz1 = M2[['flight_number', 'flight_boarding_pt','flight_boarding_time']].groupby(['flight_number', 
#             'flight_boarding_pt']).max().reset_index()
